...
function bindUsernameAutofill(source) {
  function updateSelect(el, formId) {
    el.remove();
    $(formId).find("[value=" + $(el).attr("v") + "]").remove();
  } // Generators for autocomplete
...
function bindSubjectAutofill(source) {
  function updateSelect(el, formId) {
    el.remove();
    $(formId).find("[value=" + $(el).attr("v") + "]").remove();
  } // Generators for autocomplete
...
function bindDisciplineAutofill(source) {
  function updateSelect(el, formId) {
    el.remove();
    $(formId).find("[value=" + $(el).attr("v") + "]").remove();
  } // Generators for autocomplete
...
exports.bindUsernameAutofill = bindUsernameAutofill;
exports.bindSubjectAutofill = bindSubjectAutofill;
exports.bindDisciplineAutofill = bindDisciplineAutofill;
